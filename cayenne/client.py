...
#wifi setting
SSID="YourWiFiSSID"         #insert your wifi ssid
PASSWORD="YourWiFiPassword" #insert your wifi password
...
class CayenneMQTTClient:
    ...
    * Receive and process data from Cayenne in the on_message callback.
    ...
    def begin(self, username, password, clientid, ssid=SSID, wifiPassword=PASSWORD,
